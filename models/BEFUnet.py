...
class BEFUnet3D(nn.Module):
    ...
    def forward(self, x):
        ...
        # 🔑 Instead of list → fuse embeddings into one tensor
        # Option 1: Concatenate along channels
        embeddings_tensor = torch.cat(reshaped_embed, dim=1)  # [B, C_total, D, H, W]

        return out, embeddings_tensor, None
